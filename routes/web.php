...
Route::middleware(['auth','auth.admin'])->group(function () {
    ...
    // Admin SPA pages
    Route::get('/admin/dashboard', [\App\Http\Controllers\AdminDashboardController::class, 'index'])->name('admin.dashboard');
    Route::get('/admin/statistiques', [\App\Http\Controllers\AdminStatisticsController::class, 'index'])->name('admin.statistiques');
    Route::get('/admin/notes/manage', [\App\Http\Controllers\NoteController::class, 'manage'])->name('admin.notes.manage');
    ...
    Route::patch('/admin/notes/{note}', [\App\Http\Controllers\NoteController::class, 'update'])->whereNumber('note');
    Route::delete('/admin/notes/{note}', [\App\Http\Controllers\NoteController::class, 'destroy'])->whereNumber('note');
    ...
    Route::patch('/admin/absences/{absence}', [\App\Http\Controllers\AbsenceController::class, 'update'])->whereNumber('absence');
    Route::delete('/admin/absences/{absence}', [\App\Http\Controllers\AbsenceController::class, 'destroy'])->whereNumber('absence');
    Route::post('/admin/absences/{id}/restore', [\App\Http\Controllers\AbsenceController::class, 'restore'])->whereNumber('id')->name('admin.absences.restore');
    ...
    Route::get('/admin/students/{student}/transcript', [\App\Http\Controllers\AdminStudentTranscriptController::class, 'show'])->whereNumber('student')->name('admin.students.transcript');
    Route::get('/admin/students/{student}/transcript/export', [\App\Http\Controllers\AdminStudentTranscriptExportController::class, 'export'])->whereNumber('student')->name('admin.students.transcript.export');
